    ...
    <section className="relative min-h-screen w-full overflow-hidden bg-black flex items-center justify-center py-20">
      ...
      >
        <div className="bg-gradient-to-br from-purple-600 via-pink-600 to-cyan-600 p-[2px] rounded-3xl">
          <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-3xl p-8 relative overflow-hidden max-h-[90vh] overflow-y-auto custom-scrollbar">
            {/* Grid Background */}
            ...
            >
              <div className="relative">
                <div className="w-20 h-20 bg-gradient-to-br from-green-600 to-emerald-600 rounded-2xl flex items-center justify-center shadow-2xl shadow-green-500/50">
                ...
                <motion.div
                  ...
                  className="absolute inset-0 bg-gradient-to-br from-green-600 to-emerald-600 rounded-2xl blur-xl -z-10"
                />
              </div>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-400">Join the MITS community</p>
            </motion.div>
            ...
            <form onSubmit={onSubmit} className="relative space-y-5">
              ...
              >
                ...
                <div className="relative">
                  ...
                  <motion.select
                    ...
                    value={role}
                    onChange={onChange}
                    className="w-full pl-12 pr-4 py-3 bg-gray-700/50 backdrop-blur-sm border border-purple-500/30 rounded-xl text-white focus:outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 transition-all appearance-none cursor-pointer"
                  >
                    <option value="student" className="bg-gray-800">Student</option>
                    <option value="clubAdmin" className="bg-gray-800">Club Admin</option>
                  </motion.select>
              ...
              {role === 'clubAdmin' && (
                ...
                >
                  <label className="block text-sm font-semibold text-gray-400 mb-2">Select Your Club</label>
                  <div className="relative">
                    ...
                    <motion.select
                      ...
                      className="w-full pl-12 pr-4 py-3 bg-gray-700/50 backdrop-blur-sm border border-purple-500/30 rounded-xl text-white focus:outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 transition-all appearance-none cursor-pointer"
                    >
                      <option value="" disabled className="bg-gray-800">--Please choose a club--</option>
                      {availableClubs.length > 0 ? (
                        availableClubs.map(club => (
                          <option key={club._id} value={club._id} className="bg-gray-800">{club.name}</option>
                        ))
                      ) : (
                        <option disabled className="bg-gray-800">No clubs available for admin registration</option>
                      )}
                    </motion.select>
                    <div className="absolute inset-y-0 right-0 pr-4 flex items-center pointer-events-none">
                      <svg className="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full bg-gradient-to-r from-green-600 to-emerald-600 text-white py-3 rounded-xl font-bold text-lg hover:from-green-700 hover:to-emerald-700 transition-all shadow-lg shadow-green-500/30 relative overflow-hidden disabled:opacity-50 disabled:cursor-not-allowed mt-6"
              >
                {!isLoading && (
                  <motion.div
              ...
              >
                <p className="text-gray-400">
                  ...
                  <Link to="/login" className="text-transparent bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text font-semibold hover:from-purple-300 hover:to-cyan-300 transition-all">
                    Login
                  </Link>
                </p>
              </motion.div>
            ...
            {/* Decorative Elements */}
            <div className="absolute top-4 right-4 w-20 h-20 bg-gradient-to-br from-purple-600/20 to-cyan-600/20 rounded-full blur-2xl pointer-events-none" />
            <div className="absolute bottom-4 left-4 w-16 h-16 bg-gradient-to-br from-pink-600/20 to-purple-600/20 rounded-full blur-2xl pointer-events-none" />
          </div>
        </div>
      </motion.div>
